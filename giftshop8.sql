...
INSERT INTO `category` (`Cate_id`, `Cate_Name`, `Cate_Description`,`Cate_image`) VALUES
	(1, 'Handmade', 'Gifts made by our hand. We love it!', 'storage/Images/handmade.jpg'),
	(2, 'Sweet', 'The best sweets we can find in nearby area and some delivery from other famous land!', 'storage/Images/USA_695x695.jpg'),
	(3, 'Luxury', 'Luxury gift bring out every thing you need for your lover, friend, elder,...','storage/Images/butmay.jpg');
...
Package Size: 200MG', 'storage/Images/mooncake.jpg'),
	(2, 'Wooden Cup', 1, '100$', 'The Gifts Shop', 'wooden material.
Handcrafted, durable material.
Long-term use, no harmful substances.', 'storage/Images/woodencup.webp'),
...
Color: Blue white', 'storage/Images/flower.jpeg'),
...
Has a battery-powered light, has on/off power he main material is wood (90%), small items are made of plastic', 'storage/Images/modelhouse.webp'),
...
Products can be used as housewarming gifts, opening...', 'storage/Images/wallpainting.jpg'),
...
Quantity: 1 Piece (other accessories demo in the picture is not included)', 'storage/Images/bracelet.jpg'),
...
', 'storage/Images/nerds_695x695.jpg'),
...
Hamper Dimensions - Height 13cm x Length 32cm x Width 22cm', 'storage/Images/hamper_695x695.jpg'),
...
3 x Fruit Softies, Swizzels Giant Fizzers, Refreshers, Flump, 5 x Anglo Bubbly, 3 x Chuppa Chup Lollies, 3 x Tango Popping Candy Flavours, Tropical Jawbreakers, Strawberry Jawbreakers, Love Hearts, Black Jack Chews, Fruit Salad Chews, Candy Necklace, Swizzels Parma Violets, 2 x Drum Stick Lollies, Candy Lipstick, Candy Whistle, Nougat Bar, Vimto Chew Bar, Refreshers Chew Bar, Barratt Candy Sticks, Sherbet Fountain, Chocolate Jazzles, Chocolate White Mice, Fizzy Strawberry Roller, Rainbow Drops, Fizzy Blueberry Roller, White Chocolate Snowies, Flying Saucers, Sherbet Dip Dab, Sherbet Double Dip, Drumstick Chew Bar, Wham Chew Bar, Fizz Whizz Popping Candy. 
Please note we do occasionally go out of stock of a certain sweet and if so we will replace this with something similar or double up on another sweet in the box. 
Box Dimensions - Height 5cm x Length 35cm x Width 25cm', 'storage/Images/Mega_695x695.jpg'),
...
Please note we do occasionally go out of stock of a certain sweet and if so we will replace this with something similar or double up on another sweet in the box. 
Box Dimensions - Height 5cm x Length 20cm x Width 15cm', 'storage/Images/Sweet-Box-1_695x695.jpg'),
...
Please note we do occasionally go out of stock of a certain sweet and if so we will replace this with something similar or double up on another sweet in the box. 
Box Dimensions - Height 5cm x Length 20cm x Width 15cm', 'storage/Images/Sweet-Box-2_695x695.jpg'),
...
Please note we do occasionally go out of stock of a certain sweet and if so we will replace this with something similar or double up on another sweet in the box. 
Box Dimensions - Height 5cm x Length 20cm x Width 15cm', 'storage/Images/Sweet-Box-3_695x695.jpg'),
...
Imported from the USA', 'storage/Images/USA_695x695.jpg'),
...
', 'storage/Images/nhankimcuong.jpeg'),
